...
export class CardsComponent implements OnInit {
  ...
  cdsInfo:cds[] = [
    ...
    {title: 'Iron Maiden', subtitle: 'Brave enw world', img: '/assets/imgs/D_NQ_NP_802038-MLB44425430535_122020-O.jpg', description:'CD Brave new world da banda Iron Maid3en'},
